...
const CountdownSection = () => {
    ...
    <div className=' flex flex-row max-[474px]:flex-wrap  justify-center items-center translate-y-[12.5%] max-[474px]:translate-y-[0] max-[474px]:px-0 max-[474px]:py-[20px] max-[474px]:gap-0  mx-auto body-font font-TomatoFont max-w-[1100px]'>
       ...
       <CountUp start={0} end={6200} duration={3} enableScrollSpy="true" className=' count font-semibold text-[40px] text-white max-[654px]:text-[30px] max-[474px]:text-[20px] after:content-["+"] after:text-[20px]'></CountUp>
       ...
       <CountUp start={0} end={80} duration={3} enableScrollSpy="true" className=' font-semibold text-[40px] text-white max-[654px]:text-[30px] max-[474px]:text-[20px] after:content-["+"] after:text-[20px]'></CountUp>
       <p className=' font-extralight text-[20px] text-white max-[654px]:text-[15px] max-[474px]:text-[10px] max-[474px]:text-gray-400'>Raised</p>
        ...
        <div className=' max-[474px]:w-[100%] w-[23%] px-[15px] py-[44px] bg-transparent flex flex-col items-center  max-[474px]:h-fit max-[474px]:px-0 max-[474px]:py-0'>
       <CountUp start={0} end={256} duration={3} enableScrollSpy="true" className=' font-semibold text-[40px] text-white max-[654px]:text-[30px] max-[474px]:text-[20px] after:content-["+"] after:text-[20px]'></CountUp>
       ...
       <CountUp start={0} end={50} duration={3} enableScrollSpy="true" className=' font-semibold text-[40px] text-white max-[654px]:text-[30px] max-[474px]:text-[20px] after:content-["+"] after:text-[20px]'></CountUp>
