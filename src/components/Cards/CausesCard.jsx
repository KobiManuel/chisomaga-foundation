...
useEffect(() => {
  ...
  return (
    <div className=' shadow-lg body-font font-TomatoFont flex flex-col gap-3 justify-center items-center w-[350px] h-[440.96px] max-[799px]:w-[100%] bg-white max-[382px]:h-[510px] max-[253px]:mt-12 mx-auto' >
