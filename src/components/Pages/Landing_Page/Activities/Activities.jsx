    ...
    <Wrapper bg_color=" !bg-[#f1f6f9]">
      ...
      <div className="body-font font-TomatoFont max-w-[1100px] mx-auto flex flex-col lg:flex-row max-[1040px]:flex-col justify-center items-center gap-7 md:px-6 cursor-pointer">
        <ActivityCard>
          ...
          <header>
            <h3 className=" text-white text-center text-[24px] font-semibold">
              Become a Sponsor
            </h3>
          </header>
          <span className="max-[405px]:hidden">
            <p className="text-white text-center font-extralight">
              Become a Sponsor by donating and supporting our causes with your
              money and presence and ensure that we reach as many people as
              possible
            </p>
          </span>
        </ActivityCard>
        <div className=" shadow-2xl !bg-white p-[40px] w-[80%] justify-center  lg:h-[400px] lg:md:w-[351.38px] max-[1040px]:w-[80%] max-[1040px]:h-[300px] rounded-[24px]  flex flex-col items-center max-[999px]:py-[7%]">
          ...
          <header>
            <h3 className="text-[var(--blue)] text-center text-[24px] font-semibold">
              Become a Volunteer
            </h3>
          </header>
          <span className="max-[405px]:hidden">
            <p className="text-[var(--blue)] text-center font-extralight">
              Become a Volunteer by donating and supporting our causes with your
              money and presence and ensure that we reach as many people as
              possible
            </p>
          </span>
        ...
        <ActivityCard>
          ...
          <span className="max-[405px]:hidden">
            <p className="text-white text-center font-extralight">
              Become a Team Rep by donating and supporting our causes with your
              money and presence and ensure that we reach as many people as
              possible
            </p>
          </span>
