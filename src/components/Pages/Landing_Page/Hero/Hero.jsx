  ...
  return (
    ...
    >
        ...
        <header className=" max-[330px]:hidden">
          ...
          <h4 className="text-[50px] max-[562px]:text-[40px] font-medium text-white">4 <Typed strings={['a better World', 'a better Tomorrow', 'a better Nigeria']} typeSpeed={120} backSpeed={140} loop /></h4>
