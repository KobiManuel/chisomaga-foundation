    ...
    <div className="body-font font-TomatoFont overflow-auto transition duration-500 ease-in">
      <div className="h-14 bg-[var(--primary)] py-5">
        <div className=" px-4 flex h-7 justify-between  max-[883px]:justify-center mt-0 mx-auto md:max-w-[1100px]">
          ...
          <div className="flex justify-end gap-5 pl-3 cursor-pointer text-white transition delay-150 ease-in-out">
            <FaTwitter className="  max-[883px]:hidden w-9 transition delay-150 ease-in-out  hover:-scale-x-100 hover:text-[var(--secondary)] "/>
            <FaFacebook className="  max-[883px]:hidden w-9 transition delay-150 ease-in-out  hover:-scale-x-100 hover:text-[var(--secondary)]"/>
            <FaInstagram className="  max-[883px]:hidden w-9 transition delay-150 ease-in-out  hover:-scale-x-100 hover:text-[var(--secondary)]" />
            <FaGoogle className="  max-[883px]:hidden w-9 transition delay-150 ease-in-out  hover:-scale-x-100 hover:text-[var(--secondary)]"/>
          </div>
      ...
      <div className={`bg-white transition delay-500 ease-in-out w-full overflow-hidden ${sticky &&" fixed top-0 z-40"}`}>
      ...
      <div className={!nav ? 'md:hidden z-40 fixed left-0 top-0 w-[60%] h-full border-r border-r-slate-200 bg-white ease-in-out duration-500' : 'z-40 md:hidden fixed left-[-100%]'}>
      <div>
